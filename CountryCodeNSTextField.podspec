Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/paiyou-network/CountryCodeNSTextField"
  s.license      = { :type => "MIT", :file => "LICENSE"   }
  s.author             = { "Rallet" => "info@paiyou.com"   }
  s.source       = { :git => "https://github.com/paiyou-network/CountryCodeNSTextField.git", :tag => "#{s.version}"   }
